...
<div class="container">
  <div class="row">
    ...
    <form data-toggle="validator" role="form" action="{{route('update-common-catsub')}}" enctype="multipart/form-data" method="post">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" rows="3" data-error="Nội dung mô tả bài viết" id="contentouts" name="SCONTENT" placeholder="Nội dung bài viết"  required="">{{$info->SCONTENT}}</textarea>
          <script>
        ...
        <input type="hidden" name="ID_CAT" value="{{$info->ID_CAT}}">
        <input type="hidden" name="ID_CAT_SUB" value="{{$info->ID_CAT_SUB}}">
