...
<div class="container">
  <div class="row">
    ...
    <form data-toggle="validator" role="form" action="{{route('addcommoncatsublv')}}" enctype="multipart/form-data" method="post">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" rows="3" data-error="Nội dung mô tả bài viết" id="contentouts" name="SCONTENT" placeholder="Nội dung bài viết" required="" onchange="getcontens();"></textarea>
        ...
        <input type="hidden" name="ID_CAT" value="{{$idcatsub}}">
